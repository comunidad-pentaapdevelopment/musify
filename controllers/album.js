...
function getAlbum(req, res){
	...
	}); //path es la propiedad donde se va a guardar los datos del artista asociado con el album y
	    // con el metodo populate mostramos todas las propiedades del artista
}
...
function getAlbums(req, res){
	...
	if (!artistId) {
		...
		var find = Album.find({}).sort('title'); // sort es para ordenar
	}else{
